...
- `単語`
  ...
  - 単語エリアの下に `すべてチェックを入れる` `すべてのチェックを外す` を表示
...
3. 単語エリアの下に `すべてチェックを入れる` `すべてのチェックを外す` を表示
4. `すべてチェックを入れる` を押すと、全単語のチェックを入れる
5. `すべてのチェックを外す` を押すと、全単語のチェックを外す
6. タップすると、その単語を含む `英文 + 日本語訳` を表示
7. もう一度タップするとチェックを外し、次の単語へ進む
8. チェック済み単語がなくなると `チェックされた単語はありません` を表示
